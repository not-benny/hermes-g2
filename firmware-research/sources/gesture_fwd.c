...
#define FW_FC80   ((fc80_t)0x0045fc9du)        /* FUN_0045f8fc  post UI event (Thumb) */
#define FW_MODE   ((modelookup_t)0x0045fc87u)  /* FUN_0045f8e6  foreground mode ctx (Thumb) */
#define FW_SYSEVT ((sysevt_t)0x004dec27u)      /* FUN_004da16a  send EvenHub SysEvent (Thumb) */

/* Foreground UI ctx pointer: FUN_00442d86 loads r5 = *(0x00443768) = 0x200750f8,
 * then passes r5[0] as the ctx to FUN_0045f8fc / FUN_0045f8e6. */
#define UI_CTX   (*(void *volatile *)0x200750f8u)
/* Current input event record (sourced from the literal at 0x004444bc); byte 0 is the source:
 * 0/1 = left/right temple touchpad, 4 = R1 ring. */
#define EVT_SRC  (*(volatile unsigned char *)0x2034dd90u)
