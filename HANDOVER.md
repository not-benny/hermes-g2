...
## Glasses UI modern-design investigation

`notes/glasses-ui-modern-design-2026-08-22.md` records a source-backed audit of
the 640 x 480, 4 bpp grayscale, standard-band layout and
...
firmware, or BLE behaviour changed, and no measured or validated optical or
usability claim was made. Repository references were checked at `b7db32e`;
external source URLs were checked on 22 August 2026 (12 opened, while three
valid DOI publisher endpoints denied the automated fetch with HTTP 403).
