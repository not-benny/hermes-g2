...
- **DONE — worn and overnight ring-battery availability (22 August 2026).** The
  ...
  scoped at storage and callback publication boundaries, rejects future/malformed
  data, and rate-limits unchanged writes. All
  ...
  health GET, decoded phone Health display (`59%`), live HR (`58 bpm`), and G2
