...
**Current-main refresh (23 August 2026):** rechecked against protected
`main@b762846c5c0652c0e67f8828209b40d148447272`. The surveyed builder, native
flasher, delta tooling, research archive, digest allowlists, and release policy
are unchanged; the only scoped `app.gradle` change is the preview version bump.
The decision and safety gates below therefore still apply to current main.
