...
**Current-main refresh (23 August 2026):** rechecked the implementation facts
against protected `main@b762846c5c0652c0e67f8828209b40d148447272` after the
contextual-dashboard, Hermes cockpit, Search, and Captions merges. Those features
exercise bounded glance cards, shallow lists, reviewed input, and explicit
states, but they do not supply the missing optical/usability study. The logical
frame remains 640×480 and the standard band remains 288 px; current geometry now
also makes the centred 576 px wearer-visible raster explicit. The recommendation
and evidence limits below remain in force with the corrected visible viewport.
...
- It acknowledges the real display/input envelope instead of simulating a phone
  UI in the 640×480 logical framebuffer or its centred 576 px optical raster.
...
- On A32 and Fold7 + real G2, safely evaluate optical text size,
  backing/contrast, vertical placement, dominant/non-dominant eye, edge feedback with reduced motion,
